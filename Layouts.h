...
const layout_t layouts[] = {
  ...
  {
    {
      {19, 22, 60, 62, 100,102,140,142,180,182, 221},
      {17, 24, 58, 64, 98, 104,138,144,178,184, 219},
      {15, 26, 56, 66, 96, 106,136,146,176,186, 217},
      {13, 28, 54, 68, 94, 108,134,148,174,188, 215},
      {11, 30, 52, 70, 92, 110,132,150,172,190, 213},
      {9,  32, 50, 72, 90, 112,130,152,170,192, 211},
      {7,  34, 48, 74, 88, 114,128,154,168,194, 209},
      {5,  36, 46, 76, 86, 116,126,156,166,196, 207},
      {3,  38, 44, 78, 84, 118,124,158,164,198, 205},
      {1,  40, 42, 80, 82, 120,122,160,162,200, 203}
    },
    {21, 223, 202, 0},
    224,
    2,
